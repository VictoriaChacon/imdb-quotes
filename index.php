<!DOCTYPE html>
	...
	<body>
		<h1>Persona</h1>
		<p><strong>Name</strong>:Marisa Lucero</p>
		<br>
		<p><strong>Age</strong>:24</p>
		<br>
		<p><strong>Profession</strong>:Marisa is a student and a part-time worker. She spends a lot of her time dealing with people who know a lot about movies. As a student she is always catching up with friends about the latest movies. </p>
		<br>
		<p><strong>Technology</strong>:Marisa is a Mac user but also uses her phone, which is an android device. She spends most of her time on her phone only using her computer when her phone is dead or misplaced. She has limited data connection with her phone because her service only allows high speeds for a period of time.</p>
		<br>
		<p><strong>Attitudes and Behaviors</strong>:Marisa is very busy, she does to scool full time and works in-between her school hours. When she wants information, she wants it fast and to the point. She will spend no more than three minutes looking through a page before she moves on to another source. She is a big fan of social media and likes to share her findings with friends who share her interest.</p>
		<br>
		<p><strong>Frustrations and Needs</strong>:Marisa has a big interest in films, however, with her limited amount of time she needs to get information about a film without having to watch it in its entirety.</p>
		<br>
